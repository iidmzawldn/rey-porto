const Gallery = () => {
  return (
    <>
      ...
      <div className="container min-w-full mx-auto md:container md:mx-auto">
        <div className="flex w-full bg-slate-950 flex-col lg:align-center lg:flex-row justify-between mb-[50px]">
          <div className="order-2 lg:order-1 mt-5 mb-5">
            <h4 className="text-white text-[24px] ml-4">
              Recent Work
            </h4>
            <div className="text-slate-500 max-w-[700px] mx-auto text-[24px] ml-4">
              Lorem ipsum dolor sit amet ?
            </div>
          </div>
          <div className="order-2 lg:order-2 text-center mr-4 mt-2 mb-4">
            <div>&nbsp;</div>
      ...
      <footer className="footer items-center p-4 bg-slate-950 text-neutral-content">
